...
<html>
		...
		<div class="gtco-container">
			...
			<div class="row">
				...
				<div class="col-xs-8 text-right menu-1">
					<ul>
						<!-- <li><a href="adminuserview.php">User details</a></li> -->
						
						<!-- <li><a href="adminpatientview.php">Patient Details</a></li>
	...
	<header id="gtco-header" class="gtco-cover gtco-cover-sm" role="banner"  style="background-image: url(images/registerImage.jpg) ">
				...
				<div class="col-md-12 col-md-offset-0 text-left">
					<div class="row row-mt-15em">
						...
						<div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
							<span class="intro-text-small">for company records only</span>
							<h1> Add flights here</h1>	
						</div>
					...
					<form action="aircraftdetails1.php" method="post" enctype="multipart/form-data">
												...
												<div class="row form-group">
													<div class="col-md-12">
														...
														<input type="text" class="form-control" name="atype"  required/>
													</div>
												</div>
                                                   <div class="row form-group">
													<div class="col-md-12">
												...
												<div class="row form-group">
													<div class="col-md-12">
														...
														<input type="text"  class="form-control" name="engintype"  required/>
													</div>
												</div>
