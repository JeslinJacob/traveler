		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-12">
					...
					<form action="pilotdetails1.php" method="post" enctype="multipart/form-data">
												...
												<div class="row form-group">
                                                   ...
                                                   <div class="row form-group">
													<div class="col-md-12">
														<label for="date-start">Total Flight Hours</label>
												...
												<div class="row form-group">
													<div class="col-md-12">
														<label for="date-start">Number Of Aircraft</label>
														<input type="text"  class="form-control" name="noofaircraft"  required/>
													</div>
												</div>
