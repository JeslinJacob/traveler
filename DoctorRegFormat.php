...
<html>
	...
	<header id="gtco-header" class="gtco-cover gtco-cover-sm" role="banner"  style="background-image: url(images/docbanner.jpg) ">
		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-12">
					...
					<form action="doctordetails1.php" method="post" enctype="multipart/form-data">
												...
												<div class="row form-group">
                                                   ...
                                                   <div class="row form-group">
													<div class="col-md-12">
														<label for="date-start">Location</label>
												...
												<div class="row form-group">
													<div class="col-md-12">
														<label for="date-start">Speciality</label>
												...
												<div class="row form-group">
													<div class="col-md-12">
														<label for="date-start">Phone</label>
