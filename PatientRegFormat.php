...
<html>
	...
	<header id="gtco-header" class="gtco-cover gtco-cover-sm" role="banner"  style="background-image: url(images/patbanner.jpg) ">
		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-12">
					...
					<form action="patientdetails1.php" method="post" enctype="multipart/form-data">
												...
												<div class="row form-group">
													<div class="col-md-12">
														<label for="date-start">Phone number</label>
												...
												<div class="row form-group">
													<div class="col-md-12">
														<label for="date-start">Medical Condition</label>
														<input type="text"  class="form-control" name="mcondition" required/>
													</div>
												</div>
												...
												<div class="row form-group">
													<div class="col-md-12">
														<label for="date-start">Userame</label>
