    ...
    <div class="gtco-container">
      <div class="row">
        <div class="col-md-12">
          ...
          <h3>Pilot Login</h3>
          <form  action="adminupdatepilotdetails.php" method="POST" >
                        ...
                        <div class="row form-group">
                          <div class="col-md-12">
                            <label for="date-start">Hours</label>
                        ...
                        <div class="row form-group">
                          <div class="col-md-12">
                            <label for="date-start">certification</label>
                            <input type="text"  class="form-control" name="certification" value='<?php echo "".$certification ?>' required/>
                          </div>
                        </div>

                        <div class="row form-group">
                          <div class="col-md-12">
                            <label for="date-start">No of aircraft</label>
                            <input type="text"  class="form-control" name="noofaircraft" value='<?php echo "".$noofaircraft ?>' required/>
                          </div>
                        </div>
